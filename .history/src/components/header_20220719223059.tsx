...
function Header()
{
    ...
    <div className="container-fluid">
      <NavLink to={"/"} className="navbar-brand"><img src={logo} alt="Logo" height={80} width={80} /> SurWe - Survey</NavLink>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            <NavLink to={"/survey-list"} className="nav-link" aria-current="page"><i className="fa-solid fa-diagram-project fa-lg"></i> Favorite Surveys</NavLink>
          </li>
          <li className="nav-item">
