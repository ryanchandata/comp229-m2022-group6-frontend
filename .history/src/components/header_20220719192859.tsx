    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <!-- Show Login Page or Logout Page -->
          <% if(displayName) { %>
          <li className="nav-item">
            <a className="nav-link <%= (page == 'movie-list') ? 'active' : ''; %>" aria-current="page" href="/movie-list"><i className="fa-solid fa-rectangle-list fa-lg"></i> Movie List</a>
          </li>
          <li className="nav-item">
