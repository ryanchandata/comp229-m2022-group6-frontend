...
function Contact()
{
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_znqq1jh', 'Lv6OR8n8J91mn-CAE', form.current, 'Lv6OR8n8J91mn-CAE')
          .then((result) => {
        ...
        <div className="container">
            <h1>Contact Us</h1>
                ...
                */}
                ...
                <form className="col-lg-6 col-md-10 col-sm-10" ref={form} onSubmit={sendEmail}>
