...
class AuthService
{
    ...
    public update(id: string, username: string, password: string, firstName: string, lastName: string, emailAddress: string)
    {
        return http.post(`/userEdit/${id}`, { id, username, password, firstName, lastName, emailAddress });
    }
