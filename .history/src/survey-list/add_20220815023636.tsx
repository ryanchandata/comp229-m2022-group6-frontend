...
{    
    ...
    {
        return localStorage.getItem("user") !== undefined? username:'';
    } 
    ...
    function saveSurvey(e: any)
    {
        ...
        const data: ISurveyData = {
            _id: ID,
            username: ((getUserName()?.split(":")[5])?.split(",")[0])?.replace(/["}"]+/g,''),
            name: name,
        ...
        <div className="container">
            ...
            <form onSubmit={saveSurvey} className="form" method="post">
                <div className="form-group">
                    Created by:<input type="text" className="form-control" id="userId" name="userId" value = {username} disabled></input><br />
