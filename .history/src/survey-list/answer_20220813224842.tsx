        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group">
                    ...
                    <input type= { optionType2 } /> {optiondetails2_1}<br />
                    <input type= { optionType2 } /> {optiondetails2_2}<br />
                    <input type= { optionType2 } /> {optiondetails2_3}<br /> 
                    <input type= { optionType2 } /> {optiondetails2_4}<br />
                </div>
