...
function Add()
{
    ...
    function handleCreate(event: any)
    {
        ...
        const questionsTitles = [questions.question1, questions.question2]
        ...
        <div className="container">
            ...
            <form onSubmit = { handleCreate } className="form" method="post">
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="What is your survey question?" id="question1" value ="question1" onChange = { onChangeTitle } required></input>
                ...
                <label htmlFor="name">Question 2</label>
                    <input type="text" className="form-control" placeholder="What is your survey question?" id="question1" value ="question2" onChange = { onChangeTitle } required></input>
                    <label htmlFor="optionType">Selection Type:</label>
                    <label htmlFor="optionType">Radio
                    <input type="radio" className="form-check-input" id="optionType1" name="optionType1" value="radio" onChange = { onChangeOptionType } required></input>
                    </label>
