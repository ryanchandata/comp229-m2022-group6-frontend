        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group">
                    ...
                    <input className="Visible" type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_3 } /> {optiondetails1_3}<br /> 
                    <input className="Visible" type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_4 } /> {optiondetails1_4}<br />
                    <br />
