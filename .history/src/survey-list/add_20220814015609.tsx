            ...
            <form onSubmit={saveSurvey} className="form" method="post">
                <div className="form-group">
                    ...
                    <input type="date" className="form-control" placeholder="End Date" id="dateExpire" name="dateExpire" value = {expirationDate} onChange={ onChangeExpirationDate } required></input><br />
                        Active Survey:
                        { Date.now().toLocaleString>= new Date (activationDate).toLocaleDateString && Date.now().toLocaleString<= new Date (expirationDate).toLocaleDateString }
                        <label htmlFor="status" className="switch">
                        <input id="status" type="checkbox" value="Active" onChange={ onChangeStatus } checked /><span className="slider"></span></label>
                       <br/><br/>
