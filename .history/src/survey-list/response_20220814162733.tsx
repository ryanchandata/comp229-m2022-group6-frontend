...
{   
    ...
    const chartDataQ1: IResponseData[] = [
        { optiondetails1_1, count: 5 },
        { optiondetails1_2, count: 3 },
        { optiondetails1_3, count: 4 },
        { optiondetails1_4, count: 1 },
    ];
    const chartDataQ2: IResponseData[] = [
        { optiondetails2_1, count: 5 },
        { optiondetails2_2, count: 3 },
        { optiondetails2_3, count: 4 },
        { optiondetails2_4, count: 1 },
    ];
