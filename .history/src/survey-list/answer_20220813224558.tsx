        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group">
                    ...
                    <input type= { optionType1 } /> {optiondetails1_1}<br />
                    <input type= { optionType1 } /> {optiondetails1_2}<br />
                    <input type= { optionType1 } /> {optiondetails1_3}<br /> 
                    <input type= { optionType1 } /> {optiondetails1_4}<br />
