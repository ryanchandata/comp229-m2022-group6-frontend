...
*/
    ...
    const [ response, setStat1 ] = useState<Array<IStatistic1>>([]);
    ...
    function readStatAns1()
    {
        ...
        .then((responses: any) =>{
            setStat1(responses.data.response);
            ...
            <div className="container">
                ...
                <div className="col">
                    <table className="table table-bordered table-striped table-hover">
                        ...
                        <tbody id="surveyList">
                            {   response &&
                                response.map((response: IStatistic1, index: number) => {
                                return(
                                     <tr key="{index}">
                                     <th scope="row" className='text-center'>{response._id}</th>
                                     <th scope="row" className='text-center'>{Number(response.count)}</th>
                                     </tr>
                                     );
                            })}
                            </tbody>
