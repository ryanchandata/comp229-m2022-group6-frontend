    ...
    function getResponse(id: any)
    {
        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    <tr>
                        <th scope="row" className='text-center'>{ optiondetails1_1 } </th>
                        <th scope="row" className="text-center">{ optiondetails1_2 } </th>
                        <th scope="row" className="text-center">{ optiondetails1_2 } </th>
                        <th scope="row" className="text-center">{ optiondetails1_4 } </th>
                    </tr>
                <div className="col">
