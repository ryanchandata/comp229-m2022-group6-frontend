        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group">
                    ...
                    <label htmlFor="optiondetails1_1"> {optiondetails1_1} </label>
                    <label htmlFor="optiondetails1_2"> {optiondetails1_2} </label>
                    <label htmlFor="optiondetails1_3"> {optiondetails1_3} </label>
                    <label htmlFor="optiondetails1_4"> {optiondetails1_4} </label>

                    <label htmlFor="question2"> {question2} </label>
                    <label htmlFor="optiondetails2_1"> {optiondetails2_1} </label>
                    <label htmlFor="optiondetails2_2"> {optiondetails2_2} </label>
                    <label htmlFor="optiondetails2_3"> {optiondetails2_3} </label>
                    <label htmlFor="optiondetails2_4"> {optiondetails2_4} </label>
