...
function Add()
{
    ...
    function handleCreate(event: any)
    {
        ...
        SurveyService.register(SurveyData.name, SurveyData.responses, SurveyData.title, SurveyData.optionType, SurveyData.details)
        .then(() =>{
            navigate('/add');
        }, error =>{
        ...
        <div className="container">
            ...
            <form className="form" method="post">
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Title" id="name" name="name" value="<% surveys.name %>" required></input><br /><br />
