...
export default function Answer()
{
    ...
    function showOrHideAns1Opt3() {
        ...
        {
            return (
            <input type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_3 } required/> 
            );
        }
        else { 
            return null;
    ...
    function showOrHideAns1Opt4() {
        ...
        {
            return (
            <input type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_4 } required/> 
            );
        }
        else { 
            return null;
    ...
    function showOrHideAns2Opt3() {
        ...
        {
            return (
            <input type= { optionType2 } name="question2" onChange={ onChangeQuestion2_ans } value={ optiondetails2_3 } required/> 
            );
        }
        else { 
            return null;
    ...
    function showOrHideAns2Opt4() {
        ...
        {
            return (
            <input type= { optionType2 } name="question2" onChange={ onChangeQuestion2_ans } value={ optiondetails2_4 } required/> 
            );
        }
        else { 
            return null;
        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group-answer">
                    ...
                    <input type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_1 } required/> {optiondetails1_1}<br />
                    <input type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_2 } required/> {optiondetails1_2}<br />
                    { showOrHideAns1Opt3() } {optiondetails1_3}<br />
                    { showOrHideAns1Opt4() } {optiondetails1_4}<br />
                     <br />
                    <label htmlFor="question2" > {question2} </label><br />
                    <input type= { optionType2 } name="question2" onChange={ onChangeQuestion2_ans } value={ optiondetails2_1 } required/> {optiondetails2_1}<br />
                    <input type= { optionType2 } name="question2" onChange={ onChangeQuestion2_ans } value={ optiondetails2_2 } required/> {optiondetails2_2}<br />
