        ...
        <div className="container">
            ...
            <form onSubmit={saveResponse} className="form" method="post">
                <div className="form-group">
                    ...
                    <label htmlFor="question1" className="visible" > {question1} </label><br />
                    ...
                    <input id="question1" type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_3 } /> {optiondetails1_3}<br /> 
                    <input id="question1" type= { optionType1 } name="question1" onChange={ onChangeQuestion1_ans } value={ optiondetails1_4 } /> {optiondetails1_4}<br />
                    <br />
                    <label htmlFor="question2" className="visible" > {question2} </label><br />
