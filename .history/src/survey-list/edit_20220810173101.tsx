        ...
        <div className="container">
            ...
            <form onSubmit={saveSurvey} className="form" method="post">
                <div className="form-group">
                    ...
                    <input type="date" className="form-control" id="dateActive" name="dateActive" value = {new Date(activationDate).toDateString()} onChange={ onChangeActivationDate }></input><br />
                    <label htmlFor="dateExpire">To</label>
                    <input type="date" className="form-control" id="dateExpire" name="dateExpire" value = {new Date(expirationDate).toDateString()} onChange={ onChangeExpirationDate }></input><br />
